            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary">編集 (Edit)</button>
                            <a href="{{ url('/editors/download/' . $file->id) }}" target="_blank" class="btn btn-primary">ダウンロード (Download)</a>
                            <label class="btn btn-primary" for="choose_file_{{ $file->id }}">アップロード (Upload)</label>
