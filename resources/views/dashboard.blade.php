...
<div class="container-fluid py-4">
    ...
    <div class="row mt-4">
        ...
        <div class="card z-index-2">
          <div class="card-body p-2">
            <div class="bg-dark border-radius-md py-3 pe-1 mb-3">
              <div class="chart">
                <canvas id="chart-bars" class="chart-canvas" height="340" width="863" style="display: block; box-sizing: border-box; height: 170px; width: 431px;"></canvas>
              </div>
            </div>
      ...
      <div class="col-lg-7">
        <div class="card z-index-2">
          ...
          <div class="card-body p-3">
            <div class="chart">
              <canvas id="chart-line" class="chart-canvas" height="600" width="1220" style="display: block; box-sizing: border-box; height: 300px; width: 610px;"></canvas>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="ps__rail-x" style="left: 0px; bottom: -700px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 700px; height: 731px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 288px; height: 301px;"></div>
    </div>
